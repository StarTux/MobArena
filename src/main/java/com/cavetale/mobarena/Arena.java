...
public final class Arena implements Serializable {
    private transient BuildWorld buildWorld;
     ...
     * Must call onLoad after loading to load the BuildWorld, which
    ...
    public void onLoad() {
        if (buildWorld == null) {
            ...
            if (buildWorld == null) {
                mobArenaPlugin().getLogger().severe("Build World not found: " + buildWorldPath);
            }
        }
    }
